...
# Docker 服务
docker compose -f docker/docker-compose.elasticsearch.yml up -d   # ES + Debezium Connect
docker compose -f docker/docker-compose.logging.yml up -d          # Grafana + Prometheus + Loki
```
