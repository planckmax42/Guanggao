...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public ResourceRefVO create(CreateUserRequest request) {
    ...
    @Override
    public PageResponse<UserVO> pageQuery(long current, long size, String name, Integer status) {
        ...
        List<UserVO> records = result.getRecords().stream().map(userConverter::toVO).toList();
