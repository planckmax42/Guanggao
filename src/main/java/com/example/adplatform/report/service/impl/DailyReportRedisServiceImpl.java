...
@Service
public class DailyReportRedisServiceImpl implements DailyReportRedisService {
    ...
    public void incrementDailyReport(
            ...
            long costAmount) {
        String statsKey = RedisKeyConstants.dailyStats(statDate, planId, materialId, slotId);
